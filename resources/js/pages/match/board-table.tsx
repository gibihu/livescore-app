            ...
            <Table className="">
                ...
                <TableHeader>
                    <TableRow className="h-12">
                        ...
                        <TableHead className="w-full">{type == 'fixture' ? tomorrow.toISOString().slice(5, 10) : ''}</TableHead>
                        <TableHead></TableHead>
                    </TableRow>
                </TableHeader>
                <TableBody>
                        ...
                        <React.Fragment key={index}>
                            ...
                            {item.matches?.map((match, key) => {
                                ...
                                return (
                                    <TableRow key={key}>
                                        <TableCell>
                                            <TableCellViewer item={match} className="h-14 w-full" matchEvent={type == 'fixture' ? false : true}>
                                        ...
                                        <TableCell className="flex items-center space-x-4">
                                            ...
                                            <TableCellViewer item={match} className="w-full h-14" matchEvent={type == 'fixture' ? false : true}>
                                        ...
                                        <TableCell className="min-w-15">
                                            <TableCellViewer item={match} className="w-full h-full" matchEvent={type == 'fixture' ? false : true}>
